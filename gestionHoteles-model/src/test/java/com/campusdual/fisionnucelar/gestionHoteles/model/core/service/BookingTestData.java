...
public class BookingTestData {
	...
	public static EntityResult getAllBookingData() {
		List<String> columnList = Arrays.asList("ID_BOOKING", "BK_CHECK_IN", "BK_CHECK_OUT", "BK_PRICE", "BK_ROOM",
		...
		availableRooms.addRecord(new HashMap<String, Object>() {
			{
				...
				put("id_booking", 38);
				put("rmt_price", new BigDecimal("50"));
			}
		});
	...
	public static EntityResult getChangeDatesResult() {
		EntityResult er = new EntityResultMapImpl();
		er.addRecord(new HashMap<String, Object>() {
			{
				put("id_booking", 2);
	...
	public static EntityResult getSeasonResult() {
		...
		calendar.set(3922, 11, 5);
		Date endDate = calendar.getTime();

		EntityResult seasonResult = new EntityResultMapImpl();
		seasonResult.addRecord(new HashMap<String, Object>() {
			{
				put("ss_end_date", endDate);
				put("ss_multiplier", 0.90);
