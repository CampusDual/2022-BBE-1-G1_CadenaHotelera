...
public class ExtraTestData {
	public static EntityResult getAllExtraData() {
	    ...
	    er.addRecord(new HashMap<String, Object>() {{
	        ...
	        put("EX_DESCRIPTION", "Espacio de ejercicio totalmente equipado y con sauna en el vestuario. Precio por día");
	    }});
	    er.addRecord(new HashMap<String, Object>() {{
	        put("ID_EXTRA", 1);
	    ...
	    er.addRecord(new HashMap<String, Object>() {{
	        ...
	        put("EX_DESCRIPTION", "Servicio que ofrece un menú adecuado para el cliente en tus celebraciones o reuniones");
	    }});
